...
public class TreeGUI extends JFrame {
	...
	boolean last_undo = false; // set to true when undo is clicked
	...
	public TreeGUI() {
		...
		deleteButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boolean b = tree.delete(n); // whether delete changed state of tree
				...
				if (n == tree.value && tree.left == null && tree.right == null) {
					tm.set_state(null); // the new tree is empty
					tree = null; //
					outputPanel.clearPanel();
				} else {
		...
		undoButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (!tm.is_empty()) {
					...
					JOptionPane.showMessageDialog(null, "No more undo operations possible.");
					outputPanel.clearPanel();
				}
			}
		});
